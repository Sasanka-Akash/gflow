...
<nav aria-label="mt-3">
    <ul class="pagination  justify-content-center">
        ...
        <li class="page-item">
            <a class="page-link" aria-label="Previous" <?php if ($pageno > 1) { ?> onclick="loadUsers(<?php echo ($pageno - 1) ?>);" <?php }  ?>>
        ...
        <li class="page-item">
            <a class="page-link" aria-label="Next" <?php if ($pageno < $number_of_pages) { ?> onclick="loadUsers(<?php echo ($pageno + 1) ?>);" <?php }  ?>>
