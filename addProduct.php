                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="h2 text-warning fw-bold p-2">Add New Product</h2>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mt-2 mb-2">
                                                        ...
                                                        <button class="btn btn-outline-warning fw-bold" type="button">+ Add</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> -->
                                ...
                                <div class="offset-lg-4 col-12 col-lg-4 d-grid mt-3 mb-3">
                                    <button class="btn btn-warning" onclick="addProduct();">Save Product</button>
                                </div>
