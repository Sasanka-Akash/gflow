...
<body class="bg">
    ...
    <div class="container">
        <div class="row mt-5 rounded" style="background-color: rgba(255, 255, 255, 0.074);
            ...
            <div class="col-12 text-light mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 mt-4 mb-3">
                        <button class="btn btn-warning col-12 col-lg-3 fs-6 mt-4 " onclick="findsellings();">Find</button>
                        ...
                        <div class="col-12 mt-2" id="viewArea">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="form-label fs-5 fw-bold text-light mt-1 mb-1"><?php echo $selected_data["invoice_id"]; ?></td>
                                    ...
                                    <td class="form-label fs-5 fw-bold text-light mt-1 mb-1"><?php echo $product_data["title"]; ?></td>
                                    ...
                                    <td ">
                                        ...
                                        if ($selected_data["status"] == 0) {
                                            //order comform 
                                        ?>
                                            <button class=" btn btn-success fw-bold mt-1 mb-1 " id=" btn<?php echo $selected_data["invoice_id"]; ?>">Order Get Delivery Service</button>
                                    <?php
                                        } else if ($selected_data["status"] == 1) {
                                    ?>
                                        <button class="btn btn-warning fw-bold mt-1 mb-1 " id="btn<?php echo $selected_data["invoice_id"]; ?>">Packing</button>
                                    <?php
                                        } else if ($selected_data["status"] == 2) {
                                    ?>
                                        <button class="btn btn-info fw-bold mt-1 mb-1 " id="btn<?php echo $selected_data["invoice_id"]; ?>">Dispatch</button>
                                    <?php
                                        } else if ($selected_data["status"] == 3) {
                                    ?>
                                        <button class="btn btn-primary fw-bold mt-1 mb-1 " id="btn<?php echo $selected_data["invoice_id"]; ?>">Shipping</button>
                                    <?php
                                        } else if ($selected_data["status"] == 4) {
                                    ?>
                                        <button class="btn btn-danger fw-bold mt-1 mb-1 " id="btn<?php echo $selected_data["invoice_id"]; ?>">Delivery</button>
                                    <?php
                                        } else if ($selected_data["status"] == 5) {
                                    ?>
                                        <button class="btn btn-primary fw-bold mt-1 mb-1 " id="btn<?php echo $selected_data["invoice_id"]; ?>" onclick="changeInvoiceStatus('<?php echo $selected_data['invoice_id']; ?>');">Confirm Order</button>
                                    <?php
                                        }
                                    ?>
